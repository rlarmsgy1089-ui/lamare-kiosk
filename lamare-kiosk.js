...
ov.style.cssText='position:fixed;inset:0;z-index:2147483000;background:#0f1626;display:flex;flex-direction:column;align-items:center;justify-content:center;font-family:Malgun Gothic,Apple SD Gothic Neo,sans-serif;';
...
+'<div id="lk-set" style="position:absolute;top:6px;right:6px;font-size:14px;color:#5b6c8c;cursor:pointer;user-select:none;padding:12px 14px;">설정 ⚙</div>'+'<div id="lk-gatebtn" style="position:absolute;top:6px;right:100px;font-size:14px;color:#5b6c8c;cursor:pointer;user-select:none;padding:12px 14px;">차단기 개방</div>';
...
idleStyle.textContent='@keyframes lkfloat{0%,100%{transform:translateY(0);}50%{transform:translateY(-10px);}}@keyframes lkpulse{0%,100%{transform:scale(1);opacity:1;}50%{transform:scale(1.06);opacity:.82;}}@keyframes lkbreathe{0%,100%{transform:scale(0.94);opacity:.45;}50%{transform:scale(1.06);opacity:1;}}@keyframes lksize{0%,100%{transform:scale(0.94);}50%{transform:scale(1.06);}}@keyframes lkgdot{0%{box-shadow:0 0 0 0 rgba(52,227,138,.7);}100%{box-shadow:0 0 0 14px rgba(52,227,138,0);}}@keyframes lkarm{0%,8%{transform:rotate(0deg);}35%,100%{transform:rotate(-80deg);}}@keyframes lklamp{0%,12%{fill:#ff5a5f;}24%,100%{fill:#34e38a;}}#lk-idle .row{display:flex;align-items:center;justify-content:space-between;background:#f4f6fa;border:1px solid #e3e8f0;border-radius:20px;padding:clamp(14px,3.4vw,24px) clamp(18px,4.4vw,32px);}#lk-idle .row .t{font-size:clamp(17px,3.6vw,28px);color:#3a4557;font-weight:600;}#lk-idle .row .v{font-size:clamp(24px,5vw,38px);font-weight:800;color:#1c2536;}#lk-idle .total{display:flex;flex-direction:column;align-items:center;justify-content:center;background:#eaf1ff;border:1px solid #bcd2ff;border-radius:20px;padding:0 clamp(20px,5vw,44px);}#lk-idle .total .t{font-size:clamp(15px,3vw,24px);color:#2f6bff;font-weight:700;}#lk-idle .total .v{font-size:clamp(32px,7vw,56px);font-weight:800;color:#2f6bff;line-height:1.1;}';
...
idleEl.innerHTML='<div style="background:#fff;border-radius:36px;padding:clamp(45px,9vw,72px) clamp(36px,7.5vw,66px);width:min(94vw,960px);max-width:94%;box-shadow:0 30px 80px rgba(0,0,0,.45);text-align:center;">'+'<div style="font-size:clamp(60px,15vw,87px);font-weight:900;color:#2f6bff;line-height:1;letter-spacing:-1px;">잠깐!</div>'+'<div style="font-size:clamp(39px,9vw,54px);font-weight:900;color:#1c2536;margin-top:clamp(12px,3vw,18px);">혹시 <span style="background:linear-gradient(transparent 55%,#ffe14d 55%);padding:0 3px;">주차등록</span> 하셨나요?</div>'+'<div style="height:1px;background:#eef1f5;margin:clamp(22px,5vw,28px) 8px 0;"></div>'+'<div style="margin-top:clamp(30px,6.9vw,42px);background:linear-gradient(135deg,#2f6bff,#1e50d6);border-radius:22px;padding:clamp(33px,7.5vw,45px) clamp(27px,6vw,39px);margin-left:clamp(14px,4vw,40px);margin-right:clamp(14px,4vw,40px);color:#fff;box-shadow:0 12px 30px rgba(47,107,255,.35);">'+'<div style="font-size:clamp(24px,5.4vw,33px);font-weight:600;opacity:.95;">카페 이용 시</div>'+'<div style="font-size:clamp(63px,15.75vw,90px);font-weight:800;line-height:1.1;margin-top:2px;">2시간 무료</div>'+'<div style="margin-top:clamp(15px,3.9vw,21px);font-size:clamp(20px,4.5vw,26px);font-weight:800;color:#8a5a00;background:#fdf6e3;border:1px solid #f0e6cc;border-radius:12px;padding:clamp(12px,3vw,16px) clamp(18px,4.5vw,27px);display:inline-block;">일광미식 이용 시 <span style="color:#c0392b;">+2시간</span> (최대 4시간)</div></div>'+'<div style="height:1px;background:#eef1f5;margin:clamp(33px,7.5vw,42px) 8px 0;"></div>'+'<div style="margin-top:clamp(30px,6.9vw,39px);"><div style="font-size:clamp(42px,10.5vw,60px);font-weight:900;color:#2f6bff;line-height:1.2;animation:lksize 2s ease-in-out infinite;">화면을 눌러 시작하세요</div></div>'+'</div>';
ov.appendChild(idleEl);idleEl.style.display='flex';
var gateEl=document.createElement('div');gateEl.id='lk-gate';
gateEl.style.cssText='position:absolute;inset:0;z-index:2147483600;display:none;flex-direction:column;align-items:center;justify-content:center;text-align:center;background:radial-gradient(900px 600px at 50% 100%,rgba(18,184,102,.28),transparent 70%),#0f1626;color:#f2f6fc;font-family:Pretendard,Malgun Gothic,Apple SD Gothic Neo,sans-serif;';
gateEl.innerHTML='<svg viewBox="0 -30 300 220" aria-hidden="true" style="width:min(52vw,28vh,400px);height:auto;margin-bottom:clamp(4px,1vw,10px);"><line x1="20" y1="178" x2="280" y2="178" stroke="rgba(199,210,226,.3)" stroke-width="4" stroke-linecap="round"/><rect x="123" y="120" width="34" height="58" rx="6" fill="#243357" stroke="#3a4a70" stroke-width="2.5"/><circle cx="140" cy="148" r="7" fill="#ff5a5f" style="animation:lklamp 3.6s linear infinite;"/><g style="transform-origin:140px 120px;animation:lkarm 3.6s ease-in-out infinite;"><rect x="133" y="113" width="150" height="14" rx="7" fill="#ffe14d"/><rect x="161" y="113" width="18" height="14" fill="#1c2536"/><rect x="197" y="113" width="18" height="14" fill="#1c2536"/><rect x="233" y="113" width="18" height="14" fill="#1c2536"/><rect x="267" y="113" width="14" height="14" rx="4" fill="#1c2536"/></g><circle cx="140" cy="120" r="10" fill="#c7d2e2"/><circle cx="140" cy="120" r="4.5" fill="#243357"/></svg>'+'<div style="font-size:clamp(48px,12vw,110px);font-weight:600;color:#c7d2e2;margin-top:clamp(20px,4vw,40px);line-height:1.75;letter-spacing:-.5px;">지금은 <b style="font-weight:900;color:#fff;">차단기가</b><br><b style="font-weight:900;color:#fff;">열려 있으니</b></div>'+'<div style="display:flex;justify-content:center;gap:clamp(10px,2vw,14px);margin:clamp(34px,6.5vw,56px) auto 0;"><span style="width:clamp(8px,1.6vw,12px);height:clamp(8px,1.6vw,12px);border-radius:50%;background:#34e38a;opacity:.4;"></span><span style="width:clamp(8px,1.6vw,12px);height:clamp(8px,1.6vw,12px);border-radius:50%;background:#34e38a;opacity:.7;"></span><span style="width:clamp(8px,1.6vw,12px);height:clamp(8px,1.6vw,12px);border-radius:50%;background:#34e38a;"></span></div>'+'<div style="font-size:clamp(44px,13.5vw,130px);font-weight:900;letter-spacing:-3px;line-height:1.2;margin-top:clamp(34px,6.5vw,56px);color:#ffe14d;"><span style="-webkit-text-stroke:1.4px #ffe14d;background:linear-gradient(transparent 58%,rgba(150,110,255,.55) 58%,rgba(150,110,255,.55) 92%,transparent 92%);padding:0 .12em;-webkit-box-decoration-break:clone;box-decoration-break:clone;">주차 등록 없이</span></div>'+'<div style="font-size:clamp(40px,12vw,105px);font-weight:800;letter-spacing:-1.5px;margin-top:clamp(28px,5.6vw,46px);color:#fff;">출차하셔도 됩니다</div>'+'<div id="lk-gateoff" style="position:absolute;top:6px;right:6px;font-size:14px;color:#5b6c8c;cursor:pointer;user-select:none;padding:12px 14px;">개방 해제</div>';
ov.appendChild(gateEl);
function gateOn(){try{localStorage.setItem('lamare_gate','on');}catch(e){}clearTimeout(idleTimer);gateEl.style.display='flex';}
function gateOff(){try{localStorage.removeItem('lamare_gate');}catch(e){}gateEl.style.display='none';showIdle();}
ov.querySelector('#lk-gatebtn').onclick=function(e){e.stopPropagation();
  var m=document.createElement('div');
  m.style.cssText='position:fixed;inset:0;z-index:2147483650;background:rgba(15,23,32,.55);display:flex;align-items:center;justify-content:center;font-family:Pretendard,Malgun Gothic,sans-serif;';
  m.innerHTML='<div style="background:#fff;border-radius:20px;padding:26px;width:min(92vw,380px);text-align:center;box-shadow:0 20px 60px rgba(0,0,0,.4);">'
  +'<div style="font-size:20px;font-weight:800;color:#1c2536;">차단기 개방 안내를 켤까요?</div>'
  +'<div style="font-size:14px;color:#8a97a5;margin:8px 0 20px;">끌 때까지 이 안내 화면이 계속 표시됩니다</div>'
  +'<div style="display:flex;gap:10px;"><button data-g="no" style="flex:1;padding:14px;border:none;border-radius:12px;background:#eef1f4;color:#5a6b7b;font-size:16px;font-weight:700;cursor:pointer;">취소</button>'
  +'<button data-g="yes" style="flex:1;padding:14px;border:none;border-radius:12px;background:#0a9d4e;color:#fff;font-size:16px;font-weight:800;cursor:pointer;">켜기</button></div></div>';
  document.body.appendChild(m);
  m.onclick=function(ev){var g=ev.target.getAttribute&&ev.target.getAttribute('data-g');if(g==='yes'){m.remove();gateOn();}else if(g==='no'||ev.target===m){m.remove();}};
};
gateEl.querySelector('#lk-gateoff').onclick=function(e){e.stopPropagation();gateOff();};
try{if(localStorage.getItem('lamare_gate')==='on')gateEl.style.display='flex';}catch(e){}
var idleTimer=null,popupOpen=false;
function armIdle(){clearTimeout(idleTimer);idleTimer=setTimeout(function(){if(!popupOpen)showIdle();},5000);}
function showIdle(){num='';upd();setStat('');clearTimeout(idleTimer);try{if(findErrModal())dismissModal();clearPad(getPad());}catch(e){}idleEl.style.display='flex';}
function goInput(){idleEl.style.display='none';num='';upd();setStat('');try{clearPad(getPad());}catch(e){}armIdle();}
function resetIdle(){armIdle();}
function voiceOn(){try{return localStorage.getItem('lamare_voice')!=='off';}catch(e){return true;}}
function hideIdle(){goInput();try{if(voiceOn())speak('차량번호를 입력해주세요');}catch(e){}}
...
function popup(ok,plate,ti,reason){
  ...
  back.innerHTML='<div style="position:relative;background:#18233c;border:3px solid '+color+';border-radius:30px;padding:clamp(30px,6.5vw,60px) clamp(26px,6vw,72px);width:min(92vw,700px);max-width:92%;text-align:center;box-shadow:0 26px 70px rgba(0,0,0,.55),0 0 0 7px '+color+'26;">'
    ...
    +'</div>';
  ov.appendChild(back);
  function close(){try{window.speechSynthesis.cancel();}catch(e){}if(back.parentNode)back.remove();popupOpen=false;goInput();}
  back.onclick=close;
...
ov.querySelector('#lk-set').onclick=function(){
  ...
  m.innerHTML='<div style="background:#fff;border-radius:20px;padding:26px;width:min(92vw,380px);box-shadow:0 20px 60px rgba(0,0,0,.4);font-family:Pretendard,Malgun Gothic,sans-serif;">'+'<div style="font-size:22px;font-weight:800;color:#1c2536;">직원 설정</div>'+'<div style="font-size:14px;color:#8a97a5;margin:6px 0 20px;">손님에게는 보이지 않는 관리 메뉴예요</div>'+'<button data-a="cal" style="display:block;width:100%;text-align:left;padding:16px 18px;border:2px solid #e3e8f0;border-radius:14px;background:#f7f9fc;cursor:pointer;margin-bottom:12px;">'+'<div data-a="cal" style="font-size:17px;font-weight:800;color:#26324e;">\u2699\ufe0f 키패드\u00b7할인권 다시 지정</div>'+'<div data-a="cal" style="font-size:13px;color:#8a97a5;margin-top:4px;">나이스파크 화면이 바뀌어 인식이 안 될 때</div></button>'+'<button data-a="normal" style="display:block;width:100%;text-align:left;padding:16px 18px;border:2px solid #e3e8f0;border-radius:14px;background:#f7f9fc;cursor:pointer;margin-bottom:12px;">'+'<div data-a="normal" style="font-size:17px;font-weight:800;color:#26324e;">\ud83d\udda5\ufe0f 나이스파크 화면 잠깐 보기</div>'+'<div data-a="normal" style="font-size:13px;color:#8a97a5;margin-top:4px;">뒤 화면을 직접 확인할 때 (다시 돌아올 수 있어요)</div></button>'+'<button data-a="voice" style="display:flex;align-items:center;justify-content:space-between;width:100%;padding:16px 18px;border:2px solid #e3e8f0;border-radius:14px;background:#f7f9fc;cursor:pointer;margin-bottom:12px;">'+'<div data-a="voice" style="text-align:left;"><div data-a="voice" style="font-size:17px;font-weight:800;color:#26324e;">\ud83d\udd0a 입력 안내 음성</div>'+'<div data-a="voice" style="font-size:13px;color:#8a97a5;margin-top:4px;">터치 시 \u201c차량번호를 입력해주세요\u201d 안내</div></div>'+'<div data-a="voice" id="lk-vbadge" style="flex:none;font-size:15px;font-weight:800;padding:7px 16px;border-radius:999px;background:'+(von?'#2f6bff':'#c3ccd8')+';color:#fff;">'+(von?'켜짐':'꺼짐')+'</div></button>'+'<button data-a="close" style="width:100%;padding:14px;border:none;border-radius:12px;background:#eef1f4;color:#5a6b7b;font-size:15px;font-weight:700;cursor:pointer;">닫기</button></div>';
  document.body.appendChild(m);
  m.onclick=function(e){var a=e.target.getAttribute&&e.target.getAttribute('data-a');
    ...
    else if(a==='voice'){var on=voiceOn();try{localStorage.setItem('lamare_voice',on?'off':'on');}catch(e){}var nb=!on;var bt=m.querySelector('#lk-vbadge');if(bt){bt.textContent=nb?'켜짐':'꺼짐';bt.style.background=nb?'#2f6bff':'#c3ccd8';}if(nb)try{speak('차량번호를 입력해주세요');}catch(e){}}
  };
};
