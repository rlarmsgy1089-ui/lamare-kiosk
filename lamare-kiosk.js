...
gateEl.innerHTML='<div style="display:inline-flex;align-items:center;gap:clamp(8px,1.6vw,12px);font-size:clamp(18px,3.6vw,28px);font-weight:800;letter-spacing:.5px;border-radius:999px;padding:clamp(10px,2vw,14px) clamp(20px,4vw,30px);color:#34e38a;border:2px solid rgba(52,227,138,.55);background:rgba(52,227,138,.08);">'+'<span style="width:clamp(10px,2vw,14px);height:clamp(10px,2vw,14px);border-radius:50%;background:#34e38a;animation:lkgdot 1.4s ease-out infinite;"></span>차단기 개방 중</div>'+'<div style="font-size:clamp(30px,6.4vw,50px);font-weight:600;color:#c7d2e2;margin-top:clamp(40px,8vw,70px);line-height:1.45;letter-spacing:-.5px;">지금은 <b style="font-weight:900;color:#fff;">차단기가</b><br><b style="font-weight:900;color:#fff;">열려 있으니</b></div>'+'<div style="width:clamp(60px,12vw,100px);height:5px;border-radius:5px;background:#12b866;opacity:.8;margin:clamp(34px,7vw,56px) auto 0;"></div>'+'<div style="font-size:clamp(72px,16vw,130px);font-weight:900;letter-spacing:-3px;line-height:1.1;margin-top:clamp(30px,6vw,50px);color:#ffe14d;">등록 없이</div>'+'<div style="font-size:clamp(40px,8.6vw,70px);font-weight:800;letter-spacing:-1.5px;margin-top:clamp(12px,2.4vw,20px);color:#fff;">출차하셔도 됩니다</div>'+'<div id="lk-gateoff" style="position:absolute;top:6px;right:6px;font-size:14px;color:#5b6c8c;cursor:pointer;user-select:none;padding:12px 14px;">개방 해제</div>';
