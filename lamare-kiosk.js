...
idleEl.innerHTML='<div style="background:#fff;border-radius:36px;padding:clamp(39px,9vw,84px) clamp(33px,7.5vw,78px);width:min(94vw,960px);max-width:94%;box-shadow:0 30px 80px rgba(0,0,0,.45);text-align:center;">'+'<div style="font-size:clamp(21px,4.5vw,30px);font-weight:700;color:#2f6bff;letter-spacing:2px;">라마레 사전주차등록시스템</div>'+'<div style="font-size:clamp(39px,8.4vw,57px);font-weight:800;color:#1c2536;margin-top:clamp(15px,3.6vw,24px);">주차 할인 안내</div>'+'<div style="margin-top:clamp(30px,6.9vw,45px);background:linear-gradient(135deg,#2f6bff,#1e50d6);border-radius:24px;padding:clamp(36px,8.1vw,54px) clamp(27px,6vw,39px);color:#fff;box-shadow:0 12px 30px rgba(47,107,255,.35);">'+'<div style="font-size:clamp(26px,5.7vw,36px);font-weight:600;opacity:.95;">카페 이용 시</div>'+'<div style="font-size:clamp(66px,16.5vw,105px);font-weight:800;line-height:1.1;margin-top:4px;">2시간 무료</div></div>'+'<div style="margin-top:clamp(18px,4.2vw,24px);background:#faf6ee;border:1px solid #f0e3c8;border-radius:18px;padding:clamp(24px,5.7vw,30px);">'+'<div style="font-size:clamp(22px,5.1vw,28px);font-weight:800;color:#8a5a00;">일광미식도 이용하셨나요?</div>'+'<div style="display:flex;align-items:center;justify-content:center;gap:8px;flex-wrap:wrap;font-weight:800;margin-top:clamp(12px,3vw,18px);">'+'<span style="font-size:clamp(20px,4.5vw,24px);color:#3a4657;">카페 2시간</span>'+'<span style="font-size:clamp(22px,5.1vw,27px);color:#2f6bff;">+</span>'+'<span style="font-size:clamp(20px,4.5vw,24px);color:#8a5a00;">일광미식 2시간</span>'+'<span style="font-size:clamp(22px,5.1vw,27px);color:#2f6bff;">=</span>'+'<span style="font-size:clamp(27px,6.3vw,33px);color:#c0392b;">최대 4시간</span></div></div>'+'<div style="margin-top:clamp(30px,6.9vw,42px);padding-top:clamp(27px,6vw,36px);border-top:1px solid #eef1f5;"><div style="font-size:clamp(40px,9vw,60px);font-weight:800;color:#1c2536;animation:lksize 2s ease-in-out infinite;">화면을 터치해주세요</div></div>'+'</div>';
